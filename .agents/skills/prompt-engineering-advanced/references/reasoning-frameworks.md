...
description: |
  Worked examples of Chain-of-Thought, Tree-of-Thought, and ReAct reasoning patterns with concrete prompt templates and expected outputs.
  Use when: implementing a specific reasoning framework and needing a prompt structure to copy, adapt, or reference.
---
