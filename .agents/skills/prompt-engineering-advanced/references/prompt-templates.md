...
description: |
  Copyable prompt templates for the RICE (Role, Instructions, Context, Examples) and CRISPE (Capacity, Role, Insight, Statement, Personality, Experiment) frameworks.
  Use when: building structured prompts that need a consistent role-context-instructions-examples format.
---
