...
description: |
  Catalog of 10 prompt engineering techniques with a strategy matrix comparing standard and reasoning models.
  Use when: selecting the right technique for a task, or comparing model-specific prompting approaches (e.g., GPT-4o vs o1/R1).
---
