...
name: warnings
description: |
  Common pitfalls and failure modes when using AI coding agent tools.
  Use when: reviewing agent workflows for known risks like context blindness or stale caches.
---
