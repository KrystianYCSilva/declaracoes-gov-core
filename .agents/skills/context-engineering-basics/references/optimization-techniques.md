...
description: |
  Reference for reducing token waste through context compression, JIT loading triggers, and prompt caching placement strategies.
  Use when: context is bloated, retrieval is too broad, static content should be cached, or token cost needs to be cut.
---
