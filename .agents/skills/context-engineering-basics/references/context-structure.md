...
description: |
  Reference for organizing project context into hierarchical structures, including Enterprise (complete) and Lean (basic) layouts, metadata strategy, and frontmatter patterns.
  Use when: designing a context directory structure, choosing between complete and basic layouts, or making context files discoverable to agents.
---
