...
**Passos:**
1. Verificar se `GovDateUtils` já existe em `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/` ou se é `XmlDates`
...
**Arquivos:**
- `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/GovDateUtils.java` — criar ou expandir
...
**Passos:**
1. Criar `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/VigenciaConverter.java`
...
**Arquivos:**
- `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/VigenciaConverter.java`
...
**Passos:**
1. Criar `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/VigenciaValidator.java`
...
**Arquivos:**
- `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/VigenciaValidator.java`
...
**Passos:**
1. Criar `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/GovCollectionUtils.java`
...
**Arquivos:**
- `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/GovCollectionUtils.java`
...
**Passos:**
1. Criar `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/GovFileUtils.java`
...
**Arquivos:**
- `declaracoes-gov-core-format/src/main/java/br/uem/npd/govcore/util/GovFileUtils.java`
...
**Passos:**
1. Criar `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/GovDateUtilsTest.java`
2. Criar `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/VigenciaConverterTest.java`
3. Criar `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/VigenciaValidatorTest.java`
4. Criar `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/GovCollectionUtilsTest.java`
5. Criar `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/GovFileUtilsTest.java`
...
**Arquivos:**
- `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/GovDateUtilsTest.java`
- `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/VigenciaConverterTest.java`
- `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/VigenciaValidatorTest.java`
- `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/GovCollectionUtilsTest.java`
- `declaracoes-gov-core-format/src/test/java/br/uem/npd/govcore/util/GovFileUtilsTest.java`
